class ServiceProvider {
     ...
     *
     * @param name - The name to identify a service.
     * @param service The service initializer.
     ...
     * @returns The instance of the service, or undefined if not found.
     */
    get<T = any | undefined>(className: string): T {
        return global.__singletons[className];
    }

    _singletons() {
        return global.__singletons;
    }
}

const services = new ServiceProvider();

export { services }; // Export the ServiceProvider instance
