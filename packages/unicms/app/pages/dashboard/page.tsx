import { appService } from '@/app/api/services';
import { Statistics } from '@/lib/services/storage';
...
export default function Page() {
    ...
    useEffect(() => {
        appService.stats().then((stats) => setStats(stats));
    }, []);
            ...
            <div className="p-6 sm:p-10 space-y-6">
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-indigo-600 bg-indigo-100 rounded-full mr-6">
                            <svg
                                aria-hidden="true"
                                fill="none"
                                viewBox="0 0 24 24"
                        ...
                        <div>
                            <span className="block text-2xl font-bold">{stats?.visits}</span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            <span className="block text-2xl font-bold">
                                {
                                    Object.entries(stats.requests).reduce((acc, val) =>
                                        val[1].count > acc[1].count ? val : acc
                                    )[0]
                                }
                            </span>
                            <span className="block text-gray-500">Most requested</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <span className="block text-gray-500">Most requested ip</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <span className="block text-gray-500">Administrators</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
