                ...
                <div className="max-xl:hidden md:col-span-1 max-w-72 bg-white">
                    ...
                    >
                        <div className="h-20 p-6">
                            <h2 className="text-xl font-bold font-[Inter] tracking-tighter text-neutral-800">Interfaces</h2>
                        </div>
                        <div className="mb-2 px-6">
                                <h2 className="text-xs font-semibold font-[Inter] tracking-tighter uppercase text-neutral-400">Collections ({tables?.length || 0})</h2>
                            </div>
                        <nav
                            aria-label="Main"
