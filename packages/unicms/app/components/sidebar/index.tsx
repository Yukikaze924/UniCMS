...
const unselectedStyle =
    'flex justify-center items-center bg-white hover:bg-neutral-50 rounded-xl font-semibold text-sm text-neutral-800 w-full aspect-1 p-3';
const selectedStyle =
    'flex justify-center items-center bg-indigo-50 rounded-xl font-semibold text-sm text-indigo-600 w-full aspect-1 p-3';
