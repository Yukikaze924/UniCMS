    ...
    return (
        <>
            ...
            <div
                ...
                className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${isDrawerOpen ? 'transform-none' : '-translate-x-full'} bg-white w-full max-w-[460px] dark:bg-gray-800`}
                tabIndex={1}
